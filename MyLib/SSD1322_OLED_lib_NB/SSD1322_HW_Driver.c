...
extern volatile uint8_t SPI4_TX_completed_flag;
...
{
	SPI4_TX_completed_flag = 0;
	HAL_SPI_Transmit_DMA(&hspi4, &byte_to_transmit, 1);
}
...
{
	SPI4_TX_completed_flag = 0;
	HAL_SPI_Transmit_DMA(&hspi4, array_to_transmit, array_size);
}
